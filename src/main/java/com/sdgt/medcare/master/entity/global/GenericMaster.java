...
@Entity
@Table(name = "m_generic", schema = "inventory")
@SequenceGenerator(name = "generic_seq", sequenceName = "inventory.generic_seq", allocationSize = 1)
@DynamicUpdate
@MastersEntityCustomAnnotation(showOnFrontEnd = true)
public class GenericMaster extends BaseMaster {
